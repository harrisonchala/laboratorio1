...
1. Ingresar valores (Pide la cantidad de numeros que desea ingresar el usuario, luego le pide que ingrese los adtos separados por un punto y coma, y los lee en una cadena de caracteres para luego sacara los datos de la cadena y convertirlos a entero y finalmente guardarlos en un vector de enteros
...
4. Mostrar valores maximo y minimo. (Se hallan los valores maximo y minimo y se muestran al usuario)
